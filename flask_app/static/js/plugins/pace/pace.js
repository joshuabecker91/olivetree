  ...
  Bar = (function() {
    ...
    Bar.prototype.getElement = function() {
      ...
      if (this.el == null) {
        ...
        this.el.className = "pace white-color-bg secondary-font-family pace-active";
        ...
        this.el.innerHTML = '<div class="pace-progress accent-color-bg'+_custom_class_name+'">\n  <div class="pace-progress-inner"></div>\n</div>\n<div class="pace-activity"></div>\n<div class="pace-preloader-text-percent"><div class="page-preloader-container"><div class="page-preloader-divs-container accent-color-border"><div class="page-preloader-1 accent-color-bg"></div><div class="page-preloader-2 accent-color-bg"></div><div class="page-preloader-3 accent-color-bg"></div><div class="page-preloader-4 accent-color-bg"></div><div class="page-preloader-5 accent-color-bg"></div></div><div class="page-preloader-text heading-color"></div></div></div>';
    ...
    Bar.prototype.render = function() {
      ...
      if (!this.lastRenderedProgress || this.lastRenderedProgress | 0 !== this.progress | 0) {
        ...
        // Graphicfort Modification
        el.children[2].setAttribute('data-progress-text', "" + (this.progress | 0) + "%");
